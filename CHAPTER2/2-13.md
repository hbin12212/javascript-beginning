...
자바스크립트 배열의 내장함수들 중, 자주 사용되는 내장함수들을 몇 가지 사용해보도록 하겠습니다.
...
추가로 어떠한 내장함수들이 있는지 확인하고 싶으신 분들은 [mozila 제단의 공식 사이트](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Array/at)를 통해 하나씩 살펴보시는 것을 추천드립니다.
